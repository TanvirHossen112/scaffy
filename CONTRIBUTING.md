...
```bash
git clone https://github.com/YOUR-GITHUB-USERNAME/scaffy.git
cd scaffy
```
...
```bash
git remote add upstream https://github.com/YOUR-USERNAME/scaffy.git
```
...
# origin    https://github.com/YOUR-GITHUB-USERNAME/scaffy.git (push)
# upstream  https://github.com/YOUR-USERNAME/scaffy.git (fetch)
# upstream  https://github.com/YOUR-USERNAME/scaffy.git (push)
```
